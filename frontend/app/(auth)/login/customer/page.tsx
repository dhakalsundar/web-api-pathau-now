          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-lg p-8">
            ...
            <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
              <p className="text-sm text-amber-800">
                <strong>Don't have an account?</strong> Create one to start booking shipments!
              </p>
            </div>
            ...
            <div className="mt-6 text-center space-y-2">
              ...
              <Link href="/register/customer">
                <button className="w-full px-4 py-2 border-2 border-amber-500 text-amber-600 rounded-lg hover:bg-amber-50 transition font-semibold text-sm">
                  Create an account
                </button>
              </Link>
              <Link href="/login/choose" className="block text-amber-600 hover:text-amber-700 font-semibold text-sm">
